...
LOCAL_MODULE := libc10
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libc10.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libclog
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libclog.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libcpuinfo
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libcpuinfo.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libeigen_blas
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libeigen_blas.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libnnpack
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libnnpack.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libpthreadpool
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libpthreadpool.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libpytorch_qnnpack
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libpytorch_qnnpack.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libtorch
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libtorch.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libtorch_cpu
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libtorch_cpu.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := libXNNPACK
LOCAL_SRC_FILES := \
../../../../../cpp_src/libtorch/lib/libXNNPACK.a
include $(PREBUILT_STATIC_LIBRARY)
##############################
########## libppo.so #########
##############################
...
LOCAL_SRC_FILES := \
../../../../../cpp_src/jniapi.cpp \
../../../../../cpp_src/link_list.cpp \
../../../../../cpp_src/servermessage.cpp \
../../../../../cpp_src/actorcritic.cpp
