 ...
 */
public class PPOViewFragment extends Fragment
{
    private static final String TAG = PPOViewFragment.class.getSimpleName();
     ...
     */
    public static PPOViewFragment newInstance()
    {
        PPOViewFragment fragment = new PPOViewFragment();
        fragment.setRetainInstance(true);
        return fragment;
    }

    public PPOViewFragment()
    {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        mPPOView = (CardView) view.findViewById(R.id.cardview);
        ...
        mElevationSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener()
        {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser)
            {
                ...
                mPPOView.setElevation(progress);
            }
